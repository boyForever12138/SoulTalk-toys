...
class WebSocketsClient : protected WebSockets {
 public:
#ifdef __AVR__
  typedef void (*WebSocketClientEvent)(WStype_t type, uint8_t* payload,
                                       size_t length);
#else
  ...
  void begin(IPAddress host, uint16_t port, const char* url = "/",
             const char* protocol = "arduino");
  ...
  void beginSSL(String host, uint16_t port, String url = "/",
                String fingerprint = "", String protocol = "arduino");
#else
  void beginSSL(const char* host, uint16_t port, const char* url = "/",
  ...
  void beginSslWithCA(const char* host, uint16_t port, const char* url = "/",
                      ...
                      const char* protocol = "arduino");
  void beginSslWithClientKey(const char* host, uint16_t port, const char* url,
                             const char* CA_cert, const char* clientCert,
                             const char* clientPrivateKey,
                             const char* protocol = "arduino");
#ifdef ESP32
#if ESP_ARDUINO_VERSION >= ESP_ARDUINO_VERSION_VAL(3, 0, 4)
  void beginSslWithBundle(const char* host, uint16_t port,
                          const char* url = "/",
                          const uint8_t* CA_bundle = NULL,
                          size_t CA_bundle_size = 0,
                          const char* protocol = "arduino");
#else
  void beginSslWithBundle(const char* host, uint16_t port,
                          const char* url = "/",
  ...
  void beginSocketIO(const char* host, uint16_t port,
                     const char* url = "/socket.io/?EIO=3",
                     const char* protocol = "arduino");
  void beginSocketIO(String host, uint16_t port,
                     String url = "/socket.io/?EIO=3",
                     String protocol = "arduino");

#if defined(HAS_SSL)
  void beginSocketIOSSL(const char* host, uint16_t port,
                        const char* url = "/socket.io/?EIO=3",
                        const char* protocol = "arduino");
  void beginSocketIOSSL(String host, uint16_t port,
                        String url = "/socket.io/?EIO=3",
                        String protocol = "arduino");

  void beginSocketIOSSLWithCA(const char* host, uint16_t port,
                              const char* url = "/socket.io/?EIO=3",
                              const char* CA_cert = NULL,
                              const char* protocol = "arduino");
#if defined(SSL_BARESSL)
  ...
  bool sendTXT(uint8_t* payload, size_t length = 0,
  ...
  void setConnectIP(const char* ip);

  void enableHeartbeat(uint32_t pingInterval, uint32_t pongTimeout,
...
#if (WEBSOCKETS_NETWORK_TYPE == NETWORK_SAMD_SEED) || \
    (WEBSOCKETS_NETWORK_TYPE == NETWORK_WIFI_NINA)
  const char* _CA_cert;
  const uint8_t* _CA_bundle;
#endif
